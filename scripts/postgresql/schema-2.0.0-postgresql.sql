...
CREATE INDEX idx_tcvi_table_deletion ON table_column_version_info (table_id, deletion_id);
...
CREATE INDEX IF NOT EXISTS idx_tvi_table_deletion ON table_version_info (table_id, deletion_id);
