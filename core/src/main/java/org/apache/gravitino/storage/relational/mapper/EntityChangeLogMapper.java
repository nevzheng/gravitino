 ...
 *
 * <p>This append-only log tracks structural changes to entities (alter, drop, restore) and is used
 * by the entity change poller to drive targeted invalidation of local caches on HA peer nodes.
 */
