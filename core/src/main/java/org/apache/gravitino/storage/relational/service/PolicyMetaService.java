...
public class PolicyMetaService {
  ...
  /**
   * Soft-deletes all live versions of one policy first and its base row last using one token.
   *
   * <p>Policy associations, ownership, and grants are deliberately left unchanged.
   */
  ...
  /** Restores one exact policy base-and-version deletion generation transactionally. */
