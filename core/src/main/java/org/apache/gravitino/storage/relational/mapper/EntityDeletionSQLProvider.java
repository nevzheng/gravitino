...
public class EntityDeletionSQLProvider {
  ...
  public static String insertEntityDeletion(@Param("deletion") EntityDeletionPO deletion) {
    return "INSERT INTO "
        ...
        + " parent_id, namespace_snapshot, entity_name_snapshot, name_lookup_key,"
        + " active_name_key, state, revision, deleted_at, retention_expires_at, deleted_by,"
        ...
        + " #{deletion.entityNameSnapshot}, #{deletion.nameLookupKey},"
        + " #{deletion.activeNameKey}, #{deletion.state}, #{deletion.revision},"
