...
/** The full desired mutable state of a metalake for a public Gravitino V1 PUT request. */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = false)
public final class MetalakeUpdateRequest {
  ...
  /**
   * Creates a public V1 metalake desired-state update.
   *
   * @param comment replacement comment, or null to clear it.
   * @param properties complete desired metalake properties, potentially empty.
   */
  @JsonCreator
  public MetalakeUpdateRequest(
  ...
  /**
   * @return immutable complete desired metalake properties.
   */
