...
/** A request to create a metalake through the public Gravitino V1 API. */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = false)
public final class MetalakeCreateRequest {
  ...
  /**
   * Creates a public V1 metalake-create request.
   *
   * @param name local metalake name.
   * @param comment optional metalake comment.
   * @param properties metalake properties; use an empty map when none are supplied.
   */
  @JsonCreator
  ...
  /**
   * @return immutable metalake properties.
   */
