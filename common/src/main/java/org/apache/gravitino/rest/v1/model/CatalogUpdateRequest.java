...
/** The full desired mutable state of a catalog for a public Gravitino V1 PUT request. */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = false)
public final class CatalogUpdateRequest {
  ...
  /**
   * Creates a public V1 catalog desired-state update.
   *
   * @param comment replacement comment, or null to clear it.
   * @param properties complete desired catalog properties, potentially empty.
   */
  @JsonCreator
  ...
  /**
   * @return immutable complete desired catalog properties.
   */
